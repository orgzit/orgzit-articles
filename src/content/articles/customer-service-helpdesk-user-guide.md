---
title: "Customer Service Helpdesk - User Guide"
slug: "customer-service-helpdesk-user-guide"
category: "Customer Service Helpdesk"
summary: "Streamline your customer support tickets and prevent irate customers with this simple to use Customer Service Helpdesk solution"
...
![](/images/customer-service-helpdesk-user-guide/img-1.png)

  
​

The following steps will help you quickly learn how Orgzit works by entering your own own customer tickets data and viewing the ticket reports. _It will take less than 5 minutes._

# Step 1 of 6: Overview of your screen

![](/images/customer-service-helpdesk-user-guide/img-2.png)
...
![](/images/customer-service-helpdesk-user-guide/img-3.gif)

# Step 2 of 6: Let’s create a ticket

*   Close to the top right corner of your screen, you will see a button called "**_+Ticket_**".
    

*   Click on this button to open a form for creating a ticket.
    

![](/images/customer-service-helpdesk-user-guide/img-4.png)
...
*   Click on the "**_Create_**" button to create the ticket.
...
![](/images/customer-service-helpdesk-user-guide/img-5.png)
...
![](/images/customer-service-helpdesk-user-guide/img-6.png)
...
![](/images/customer-service-helpdesk-user-guide/img-7.png)
...
![](/images/customer-service-helpdesk-user-guide/img-8.png)

![](/images/customer-service-helpdesk-user-guide/img-9.gif)
...
<div class="intercom-container intercom-align-center"><a class="intercom-h2b-button" target="_blank" href="https://calendly.com/teamorgzit/30min">Let's Chat</a></div>
...
![](/images/customer-service-helpdesk-user-guide/img-10.png)

*   Close to the top right corner of this workspace page, you will see a button called "**_+Customer_**".
    

*   Clicking on this button will open a dialog box which will ask for the details of the ticket you want to create.
    

![](/images/customer-service-helpdesk-user-guide/img-11.png)
...
*   Click on "**_Create_**" to create a record in the desired/selected table.
...
*   **Dealers**: If you sell through a dealer or franchise network or through channel partners, this table will maintain a list of the dealers associated with your business. [Learn how to add a dealer](/articles/how-to-add-a-dealer).  
...
![](/images/customer-service-helpdesk-user-guide/img-12.gif)

_Are you ready to setup a customized Customer Service Helpdesk for your business? You can get started by setting up a meeting with an Orgzit solutions expert._

<div class="intercom-container intercom-align-center"><a class="intercom-h2b-button" target="_blank" href="https://calendly.com/teamorgzit/30min">Setup a meeting with Orgzit Expert</a></div>
